...
float4 _main(PS_Input Input)
{
    ...
    UVOffset = (tex2D(Sampler_g_uvDistortionSampler, advancedParam.AlphaUV).xy * 2.0f) - 1.0f.xx;
    ...
    Output = param_1;
    float4 AlphaTexColor = tex2D(Sampler_g_alphaSampler, advancedParam.UVDistortionUV + UVOffset);
