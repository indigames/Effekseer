...
vec4 _main(PS_Input Input)
{
    ...
    UVOffset = (texture(Sampler_g_uvDistortionSampler, advancedParam.AlphaUV).xy * 2.0) - vec2(1.0);
    ...
    Output = param_1;
    vec4 AlphaTexColor = texture(Sampler_g_alphaSampler, advancedParam.UVDistortionUV + UVOffset);
