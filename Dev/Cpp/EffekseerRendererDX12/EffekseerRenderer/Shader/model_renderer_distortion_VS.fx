...
static const VS_Output _487 = { 0.0f.xxxx, 0.0f.xx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xxxx, 0.0f.xx };
...
VS_Output _main(VS_Input Input)
{
    ...
    float4 modelColor = _364_fModelColor[Input.Index.x];
